...
1. [FOV Metadata Organization (A)](fov_metadata.qmd): each experiment session consists of multiple fields of view (FOVs). This step helps users organize the metadata of the FOVs. 
...
3. [Categorical feature extraction (C)](categorical_feature_extraction.qmd): extract the categorical features such as the treatment, time point, etc based on the FOV name.

- Users can then upload the extracted datasets to perform [Data Analysis](data_analysis.qmd). 
