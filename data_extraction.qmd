...
The user can [configure](data_extraction_config.qmd) the system once and apply it to future data. After configuration, the user can extract features from raw data using the following steps, inspired by the [design](#index.qmd#design):
