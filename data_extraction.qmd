...
1. [FOV Metadata Organization](fov_metadata.qmd): each experiment session consists of multiple field of views (FOVs). This steps helps user organize the metadata of the FOVs. 
