...
## Reset
Users can reset the configuration to the default settings, which are configured in the [configuration step](data_extraction_config.qmd) in the Data Extraction module.
