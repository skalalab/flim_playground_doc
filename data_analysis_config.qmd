...
Open **Data Analysis** and select **Univariate → Feature Comparison** for the view shown here. Clear **Use Dataset from Data Extraction**, then upload `iris.csv`.
...
![Clear the extraction checkbox before uploading your own table.](analysis_ui_shots/config_upload.png){width=65% fig-align=center fig-pos="H" fig-alt="Use Dataset from Data Extraction is unchecked above the Upload your table area and Browse files button."}
