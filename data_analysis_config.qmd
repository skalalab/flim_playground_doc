...
## Reset
Users can reset the configuration to the default settings, which are configured in the [configuration step](#sec-data-extraction-config) in the Data Extraction module.
