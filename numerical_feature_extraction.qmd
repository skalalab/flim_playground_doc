...
Once confirmed, on the left, it will ask the user either they want to proceed to apply the calibration settings to the downstream extractors, or they want to go back. They can also save the settings to the metadata file.  
