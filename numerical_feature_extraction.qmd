...
Similar to the [fov metadata extraction](fov_metadata.qmd#fov-metadata) step, FLIM Playground extracts the features and displays the extraction status for field of view. 
