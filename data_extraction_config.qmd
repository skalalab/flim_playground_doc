...
::: {.callout-note}
If the decay type is [2D decay](#2d-decay), the [Intensity Morphology](#sec-intensity-morphology) and [Intensity Texture](#sec-intensity-texture) feature extractors are **not** applicable.
:::
