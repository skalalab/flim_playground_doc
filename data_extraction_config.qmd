...
Since instrumental response function (IRF) or the reference dye are measured for each channel, they are set in the [per-channel settings](#per-channel-settings). The reference dye's lifetime is channel-agnostic. 
