...
For a single component, $\tau_{m,iw} = \tau_1$. Both $\tau_{mean}$ and $\tau_{m,iw}$ are reported, whether the features come from fitting or from the [pixel pre-fit](#pixel-pre-fit) workflow.
