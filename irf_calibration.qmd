...
::: {#fitting-options}
![Fitting controls combine the objective and per-channel model settings.](extraction_ui_shots/fitting_option.png){width=80% fig-align=center fig-alt="MLE metric, two components per channel, start and end time gates, fixed-lifetime expanders, Fix the Shift, and Optimize for Shifts."}
:::
...
![Change the NADH gates to T1 = 20 and T2 = 240, then optimize the shifts.](extraction_ui_shots/time_gate_choose.png){width=65% fig-align=center fig-alt="NADH fitting controls show two components, Start T1 set to 20, End T2 set to 240, Fix the Shift, and Optimize for Shifts."}
