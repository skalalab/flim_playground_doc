...
# Input
User can upload the dataset outputted from the [Data Extraction](data_extraction.qmd) directly or *their own datasets* in **csv** (Comma Separated Values) format after finishing the [interactive configuration](data_anlaysis_config.qmd) setup. 
...
In either case, the dataset should have:
