...
Welcome to the FLIM Playground 🥳🎉🥂! This is an interactive graphical user interface (GUI) that allows you to extract single-cell features from fluorescence lifetime imaging microscopy (FLIM)^[which can be readily extended to other imaging modalities] raw data ([Data Extraction](#sec-data-extraction)) and analyze extracted features or your own datasets using a built-in repertoire of methods ([Data Analysis](#sec-data-analysis)). 
