...
::: {.content-visible when-format="html"}
A video of the entire workflow (Data Extraction and Data Analysis):

{{< video src="data_extraction_n_analysis.mp4" controls=true style="object-fit:cover; border-radius:12px; display:block; margin:auto;" >}}
:::
