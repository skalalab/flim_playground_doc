...
To quickly try out different analysis methods, download this [sample dataset, will be provided soon] and try the [online demo](https://flim-playground.streamlit.app/). If you prefer to use your own data, read [data analysis configuration](data_analysis_config.qmd) to learn how to configure the system.
