...
\begin{tabular}{@{} >{\raggedright\arraybackslash}p{2.5cm}
  ...
  \toprule
  Data Levels & Input Types & Methods & Feature Semantics \\
  \midrule
  ...
  \cellcolor{gray!65}Field of View
    & \multicolumn{2}{>{\raggedright\arraybackslash}p{8cm}}{Vendor-specific decay format + aggregation of all channels' input types and methods}
