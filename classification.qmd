# Classification
A machine learning classifier learns patterns from categorized data and then predicts the category of new, unseen data. This module provides a set of machine learning classifiers and interactive widgets to help user perform classification. 
...
- Choose the classifier and train-test split: the slider controls the proportion of the data used to train the classifier and the rest will be used as unseen data to test its generalizability.
