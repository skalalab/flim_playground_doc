...
- **IRF shifting** is applied only when the chosen calibration method is IRF shift calibration. The IRF is shifted using the shift values as described in the [Shift IRF step](numerical_feature_extraction.qmd#shift-irf). Under fluorescence lifetime standard calibration, no IRF shift is applied.
