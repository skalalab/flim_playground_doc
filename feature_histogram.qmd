...
### Example 
Pham et al. [@Pham2025] used GMM with hard thresholding to create gates using NAD(P)H $a_1$ and optical redox ratio. These gates were used to define metabolically stressed and fit cells in their study of the impact of cryopreservation on T cell metabolism. 
