...
::: {.callout-tip}
If the issue persists after renaming the files to match the required prefix, hit the `Rescan Folder` button to force a re-scan of the folder.
![](extraction_ui_shots/fov_rescan.png){width=20% fig-align=center}
:::
...
![](extraction_ui_shots/fov_channel_preview.png){width=60% fig-align=center} 
