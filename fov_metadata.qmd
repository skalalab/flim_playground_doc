...
Since the [2D decay](data_extraction_config.qmd#2d-decay) file does not provide the `duration` and the number of `time bins` per laser pulse interval, users need to specify them. 
