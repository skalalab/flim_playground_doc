...
After finding the [fluorescence lifetime standard](#fluorescence-lifetime-standard), FLIM Playground checks that it is a 3D TIFF and that exactly one dimension matches the decay's time-bin count. A missing or ambiguous time axis prevents metadata export.
