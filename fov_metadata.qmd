...
If the selected fit free calibration method is [reference dye](data_extraction_config.qmd#calibration-method), the user can specify the reference dye file path and the reference dye lifetime here, the default of those are copied from the reference dye config. 
