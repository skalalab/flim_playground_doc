...
![](extraction_ui_shots/fov.png){width=100% fig-align=center}
...
If there is non-zero number of FOVs with ✅, a preview of the metadata data sheet will be shown for the user to check. 
...
- `nadh_input_type`, `nadh_imaging_modality`, `fad_input_type`, `fad_imaging_modality`: the [decay type](#decay-type) for each channel. If they share the same imaging modality, the decay types should be the same. 
