...
The downloaded dataset keeps all the features plus the new categorical feature column (`k_means_cluster`), which is recognized by any methods in Data Analysis as a categorical feature like others, and rows that pass the [filters](data_analysis.qmd#filter-widgets).