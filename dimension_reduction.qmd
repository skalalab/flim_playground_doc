...
## Shared Components
- On the left, user can select the numerical features for the dimension reduction: it shares the numerical [selection widgets](data_analysis.qmd#multivariate-analysis) that allows user to select multiple features from each feature group. 
