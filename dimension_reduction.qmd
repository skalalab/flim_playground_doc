...
Hyperparameters really matter, therefore we provide a set of interactive widgets to help users change the hyperparameters and see their effects on the dimension reduction in real time. 
